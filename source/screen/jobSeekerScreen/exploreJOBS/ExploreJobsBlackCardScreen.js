          ...
          <FlatList
            ...
            renderItem={({ item }) => {
              return (
                ...
                //   onSwipeLeft={() => DeleteData(item?.id)}
                >
                  <JobsCardDetailsTWO 
                    // Sidebar={true}
                    ...
                    company={item.company_name || item.company_details.company_name}
                    ...
                    Skills={item.skill_list || item.skill_set}
