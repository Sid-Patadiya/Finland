...
export default function JNMVLMapView({ route, navigation, latitude, longitude }) {
                        ...
                        <View style={{ alignItems: 'center' }}>
                          ...
                          {loginToken == null ? null :
                            <View style={[styles.matchView, { marginTop: -10 }]}>
                              ...
                              <Text style={styles.matchText}>
                                {parseInt(item.percentage_match) == 0 || parseInt(item.percentage_match) == null ? '10 %' : parseInt(item.percentage_match) + "%"}
                              </Text>
                            </View>
                          }
                        </View>
